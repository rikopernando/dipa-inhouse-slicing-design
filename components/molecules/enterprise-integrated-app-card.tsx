...
interface EnterpriseIntegratedAppCardProps {
  card: EnterpriseCardType;
}

/**
 * EnterpriseIntegratedAppCard Component
 *
 * Displays an enterprise feature card with image and description
 * Part of the Enterprise Section organism
 */
export function EnterpriseIntegratedAppCard({ card }: EnterpriseIntegratedAppCardProps) {
  return (
    <div
      className={cn(
